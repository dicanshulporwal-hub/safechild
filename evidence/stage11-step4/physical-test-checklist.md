...
| **W10**| **Automatic DNS Re-protection** | Restart service: `Start-Service SafeBrowseChildService` | Automatic re-protection completed without manual intervention; full DNS re-enforcement was observed within approximately 20 seconds in repeated crash cycles. | **PASS** | 2026-09-24 04:38:02 |
| **W11**| **Backend Outage with Cached Policy** | Block backend IP (`100.88.17.16:11002`); browse web | Backend connectivity was locally blocked; cached policy remained present, DNS enforcement remained active, SafeBrowse remained Protected, and internet continued working. | **PASS** | 2026-09-24 04:41:15 |
| **W12**| **Backend Automatic Recovery** | Unblock backend IP | Backend connectivity was restored without disrupting local protection; protection remained healthy. | **PASS** | 2026-09-24 04:43:30 |
...
| **W15**| **Modern Standby / Sleep -> Wake** | Sleep laptop for 10m; wake machine | Laptop entered Modern Standby / Sleep and was subsequently woken; service was Running after wake, exactly one ServiceHost and one Child Pilot were present, UDP 127.0.0.1:53 was healthy, DNS was 127.0.0.1, Parent Status was Protected, and internet worked. | **PASS** | 2026-09-24 04:55:40 |
